...
Motors::Motors(QWidget *parent) : Page(parent)
{
    int i;
    setupUi(this);
    char devname[32];
...
void Motors::on_ui_MotorDecButton_clicked(bool)
{
...
void Motors::on_ui_MotorIncButton_clicked(bool)
{
...
void Motors::on_ui_PositionRadio0_clicked()
{
...
void Motors::on_ui_VelocityRadio0_clicked()
{
...
void Motors::on_ui_PowerRadio0_clicked()
{
        ui_TargetPositionLabel0->hide();
        ui_TargetPositionLine0->hide();
...
void Motors::on_ui_PositionRadio1_clicked()
{
...
void Motors::on_ui_VelocityRadio1_clicked()
{
...
void Motors::on_ui_PowerRadio1_clicked()
{
        ui_TargetPositionLabel1->hide();
        ui_TargetPositionLine1->hide();
...
void Motors::on_ui_PositionRadio2_clicked()
{
...
void Motors::on_ui_VelocityRadio2_clicked()
{
...
void Motors::on_ui_PowerRadio2_clicked()
{
        ui_TargetPositionLabel2->hide();
        ui_TargetPositionLine2->hide();
...
void Motors::on_ui_PositionRadio3_clicked()
{
...
void Motors::on_ui_VelocityRadio3_clicked()
{
...
void Motors::on_ui_PowerRadio3_clicked()
{
        ui_TargetPositionLabel3->hide();
        ui_TargetPositionLine3->hide();
...
void Motors::on_ui_TargetSpeedPowerLine0_selectionChanged()
{
    int value;
...
void Motors::on_ui_TargetSpeedPowerLine1_selectionChanged()
{
    int value;
    Keypad user_keypad(this);
...
void Motors::on_ui_TargetSpeedPowerLine2_selectionChanged()
{
    int value;
    Keypad user_keypad(this);
...
void Motors::on_ui_TargetSpeedPowerLine3_selectionChanged()
{
    int value;
    Keypad user_keypad(this);
...
void Motors::on_ui_TargetPositionLine0_selectionChanged()
{
    Keypad user_keypad(this);
...
void Motors::on_ui_TargetPositionLine1_selectionChanged()
{
    Keypad user_keypad(this);
...
void Motors::on_ui_TargetPositionLine2_selectionChanged()
{
    Keypad user_keypad(this);
...
void Motors::on_ui_TargetPositionLine3_selectionChanged()
{
    Keypad user_keypad(this);
...
void Motors::on_ui_PlayButton0_toggled(bool state)
{
    QString value;
...
void Motors::on_ui_PlayButton1_toggled(bool state)
{
    QString value;
...
void Motors::on_ui_PlayButton2_toggled(bool state)
{
    QString value;
...
void Motors::on_ui_PlayButton3_toggled(bool state)
{
    QString value;
...
void Motors::clearMotorCounter()
{
    ioctl(m_pid[m_motorNumber], CBOB_PID_CLEAR_COUNTER);
}
void Motors::moveMotorPower(int motor,int power)
{
    signed char pwm = power;
    write(m_pwm[motor], &pwm, 1);
}
void Motors::moveAtVelocity(int motor,int velocity)
{
    short v = velocity;
    write(m_pid[motor], &v, 2);
}
void Motors::moveToPosition(int motor,int speed, int target_position)
{
        short v = speed;
