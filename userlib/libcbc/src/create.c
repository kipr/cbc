...
void set_create_total_angle(int a) {get_create_normalized_angle(0.001); stateOfCreate.angle.lastUpdate=seconds(); stateOfCreate.totalAngle=a;}
void set_create_normalized_angle(int a) {
        get_create_total_angle(0.001);//update total angle, clears incremental buffer before setting normalized angle
        stateOfCreate.angle.lastUpdate=seconds();
